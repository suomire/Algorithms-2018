...
abstract class AbstractAlgorithmsTests {
    ...
    fun optimizeBuyAndSell(optimizeBuyAndSell: (String) -> Pair<Int, Int>) {
        ...
        assertEquals(3 to 7, optimizeBuyAndSell("input/buysell_in4.txt"))
        assertEquals(1 to 2, optimizeBuyAndSell("input/buysell_in5.txt"))
        assertEquals(1 to 407, optimizeBuyAndSell("input/buysell_in6.txt"))
        try {
...
Еще старушка не забыла
    ...
    fun calcPrimesNumber(calcPrimesNumber: (Int) -> Int) {
        ...
        assertEquals(0, calcPrimesNumber(-84630))
        assertEquals(10544, calcPrimesNumber(111111))
    }
